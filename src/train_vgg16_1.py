...
model = VGG_16.VGG16_1()
# 载入预训练参数
# model.load_state_dict(torch.load("../model/vgg16_1/vgg16_1_101.pth"))
# 模型放入GPU
if gpu_available:
    model = model.cuda()
...
# tensorboard
writer = SummaryWriter("../logs/vgg16_1/20230411")
...
for i in range(epoch):
    ...
    # 保存模型
    if i % 100 == 0:
        torch.save(model.state_dict(), "../model/vgg16_1/vgg16_1_{}.pth".format(i + 1))
    print("\n")
